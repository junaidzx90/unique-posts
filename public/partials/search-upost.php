<div id="search_module">
    <div class="search_upost_contents">
        <form method="get" class="search_box">
            <input type="text" name="unique_post_search" placeholder="Search by Post Unique ID" value="<?php echo ((isset($_GET['unique_post_search'])) ? $_GET['unique_post_search'] : '') ?>">
        ...
        if($uid){
            ...
            if($upost_id){
                ...
                <div class="result_contents">
                    <div class="upost">
                        <h3><a href="<?php echo get_the_permalink( $upost->ID ).'?uid='.$uid ?>"><?php echo __($upost->post_title, 'unique-posts') ?></a></h3>
                        <p class="post-info">Created by: 
                            <b><?php 
                            $user = get_user_by( "ID", $upost->post_author ); 
                            echo $user->display_name;
                            ?></b>, 
                            Date: <b><?php echo get_the_date( "F j, Y, g:i a", $upost->ID ) ?></b>
                        </p>
